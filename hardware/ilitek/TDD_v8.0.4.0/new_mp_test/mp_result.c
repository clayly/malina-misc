...
{
	int i = 0, j = 0,line_num, max_channel = 0, length = 0;
	...
	if(mp_test_data->UIConfig.bUniformityTest == 1)
	{
		...
		length += sprintf(SetCsvData+length,"\nDelta | left - Right | and Delta | Up - Down | Spec:,,");
		...
		length += sprintf(SetCsvData+length,"\nBD_Notch_BOTTOM ,,<%d => PASS", mp_test_result->uniformity_judge.notch);
		...
		length += sprintf(SetCsvData+length,"\nBorder Ratio Spec:,,\n");
		length += sprintf(SetCsvData+length,"BDVA_Top_Ratio_Max = %d\n", mp_test_data->bd_va_ratio_max.bd_top);
		length += sprintf(SetCsvData+length,"BDVA_Top_Ratio_Min = %d\n", mp_test_data->bd_va_ratio_min.bd_top);
		length += sprintf(SetCsvData+length,"BDVA_Bottom_Ratio_Max = %d\n", mp_test_data->bd_va_ratio_max.bd_bottom);
		length += sprintf(SetCsvData+length,"BDVA_Bottom_Ratio_Min = %d\n", mp_test_data->bd_va_ratio_min.bd_bottom);
		length += sprintf(SetCsvData+length,"BDVA_Left_UPPER_Ratio_Max = %d\n", mp_test_data->bd_va_ratio_max.bd_l_top);
		length += sprintf(SetCsvData+length,"BDVA_Left_UPPER_Ratio_Min = %d\n", mp_test_data->bd_va_ratio_min.bd_l_top);
		length += sprintf(SetCsvData+length,"BDVA_Left_LOWER_Ratio_Max = %d\n", mp_test_data->bd_va_ratio_max.bd_l_bottom);
		length += sprintf(SetCsvData+length,"BDVA_Left_LOWER_Ratio_Min = %d\n", mp_test_data->bd_va_ratio_min.bd_l_bottom);
		length += sprintf(SetCsvData+length,"BDVA_Right_UPPER_Ratio_Max = %d\n", mp_test_data->bd_va_ratio_max.bd_r_top);
		length += sprintf(SetCsvData+length,"BDVA_Right_UPPER_Ratio_Min = %d\n", mp_test_data->bd_va_ratio_min.bd_r_top);
		length += sprintf(SetCsvData+length,"BDVA_Right_LOWER_Ratio_Max = %d\n", mp_test_data->bd_va_ratio_max.bd_r_bottom);
		length += sprintf(SetCsvData+length,"BDVA_Right_LOWER_Ratio_Min = %d\n", mp_test_data->bd_va_ratio_min.bd_r_bottom);
		length += sprintf(SetCsvData+length,"BDVA_Notch_Ratio_Max = %d\n", mp_test_data->bd_va_ratio_max.notch);
		length += sprintf(SetCsvData+length,"BDVA_Notch_Ratio_Min = %d\n", mp_test_data->bd_va_ratio_min.notch);
